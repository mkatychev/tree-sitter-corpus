...
enum ts_symbol_identifiers {
  ...
  sym__string = 28,
  sym_quantifier = 29,
  sym__immediate_identifier = 30,
  sym__node_identifier = 31,
  sym_capture = 32,
  sym_string = 33,
  sym_parameters = 34,
  sym_list = 35,
...
static bool ts_lex(TSLexer *lexer, TSStateId state) {
  ...
  switch (state) {
    ...
    case 43:
      ...
      END_STATE();
    case 44:
      ACCEPT_TOKEN(sym__header_delim);
      END_STATE();
    default:
      return false;
  }
...
static const uint16_t ts_parse_table[LARGE_STATE_COUNT][SYMBOL_COUNT] = {
  [0] = {
    ...
    [sym_text] = ACTIONS(1),
    [sym__header_delim] = ACTIONS(1),
    [sym__median] = ACTIONS(1),
  },
  [1] = {
...
extern const TSLanguage *tree_sitter_ts_test(void) {
